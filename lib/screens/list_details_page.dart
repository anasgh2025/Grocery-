...
class _ListDetailsPageState extends State<ListDetailsPage> {
  ...
  // Example mapping for grouping (should be replaced with your actual logic)
    ...
    return Dismissible(
      ...
      confirmDismiss: (direction) async {
        if (direction == DismissDirection.startToEnd) {
          ...
          // Show photo/favorite actions (handled by buttons, don't dismiss)
          return false;
        }
        return false;
      },
  ...
  Map<String, List<Map<String, dynamic>>> get groupedUntickedItems {
    ...
    for (final item in untickedItems) {
      final cat = _itemToCategory[item['name']] ?? 'Other';
  ...
  void _onSearchChanged(String value) async {
    ...
    setState(() {
      _suggestions = []; // Replace with actual suggestions
